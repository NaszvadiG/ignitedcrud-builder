...
class Crud_export extends CI_Model {
    ...
    public function get_structure($table)
    {
     ...
     public function generate_view($table,$form_array)
     {
        ...
        $view_path  = "crud_files/$table";
        mkdir($view_path);

        mkdir("crud_files/$table/views");
        mkdir("crud_files/$table/views/$table");

         mkdir("crud_files/$table/controllers");
        mkdir("crud_files/$table/controllers/admin");


        mkdir("crud_files/$table/models");
        mkdir("crud_files/$table/models/$table");
        ...
        if ( ! write_file("crud_files/$table/views/$table/new.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        if ( ! write_file("crud_files/$table/views/$table/edit.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        if ( ! write_file("crud_files/$table/views/$table/breadcrumb-all.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        if ( ! write_file("crud_files/$table/views/$table/breadcrumb-edit.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
        ...
        if ( ! write_file("crud_files/$table/views/$table/breadcrumb-new.php", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
    ...
    public function generate_controller($table, $form_array)
    {
       ...
       //read the master controller file
        ...
        if ( ! write_file("crud_files/$table/controllers/admin/$tmp", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
   ...
   public function generate_model($table)
   {
        ...
        //first create a directory with the name of the table
        $model_path  = "crud_files/models/$table";
        ...
        if ( ! write_file("crud_files/$table/models/$table/$tmp", $string))
        {
            echo 'Unable to write the file, check you have right permissions';
        }
        else
...
/* End of file Crud_export.php */
/* Location: ./application/models/crud/Crud_export.php */