...
--
-- Table structure for table `IGS_uploads`
--
...
(4, 'admin', '$2y$10$BV.iHu7G6KytVcALTg2ad.9g5xq/4TEm02f/HBZGHQCVnUb/iHA.6', '2015-11-22', 179, 0, 1, 0, '', '', '', 0, '44c75aa4e65e3760d0c019c5ffcc0655', '', '', 0, 1, 'Ignited Crud Builder');
...
--
-- Indexes for table `IGS_uploads`
--
ALTER TABLE `IGS_uploads`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `IGS_uploads`
--
ALTER TABLE `IGS_uploads`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
